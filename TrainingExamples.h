...
#ifndef RNN_TRAININGEXAMPLES_H
#define RNN_TRAININGEXAMPLES_H
#include "Samples.h"
#include <string>
#include <iostream>
#include <fstream>
...
using namespace std;
using std::string;
using DataSample = vector<Samples>;
...
public:
    ...
    TrainingExamples(string File, int sampleSize, int columnSize,
                     int outputSize) {
