...
//
#ifndef RNN_NEURALNETWORK_H
#define RNN_NEURALNETWORK_H
...
public:
    ...
    int BackPropogation(TrainingExamples TraineeSamples, double LearningRate,
                        Sizes Layersize, string Savefile, string TestFile, int sampleSize,
    ...
    double TestLearnedData(Sizes Layersize, string learntData, string TestFile,
    ...
    double TestTrainingData(Sizes Layersize, string learntData, string TestFile,
...
void NeuralNetwork::SaveLearnedData(Sizes Layersize, string filename) {
...
void NeuralNetwork::LoadSavedData(Sizes Layersize, string filename) {
...
double NeuralNetwork::TestTrainingData(Sizes Layersize, string learntData,
                                       string TestFile, int sampleSize, int columnSize, int outputSize,
                                       ofstream & out2) {
    bool valid;
    double count = 1;
    double total;
...
int NeuralNetwork::BackPropogation(TrainingExamples TraineeSamples,
                                   double LearningRate, Sizes Layersize, string Savefile, string TestFile,
